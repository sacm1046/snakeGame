let matrizPlayer = [["p1-ta1", "p1-tb1", "p1-tc1", "p1-td1", "p1-te1", "p1-tf1", "p1-tg1", "p1-th1", "p1-ti1", "p1-tj1"],
...
function eaten() {
    if (snake[0] === food[0]) {
        ...
        document.getElementById('score').innerHTML=count
        /* if(up !== 0){
            snake.push(matrizPlayer[randomX1+1][randomY1])
            ...
            snake.push(matrizPlayer[randomX1][randomY1+1])
